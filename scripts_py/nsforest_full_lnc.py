"""
python nsforest_full_lnc.py {data file name} {structure} {cluster header} {subset col}
"""
...
Path(f"dendrogram_{cluster_header}_full.svg").rename(
...
if store_preprocessed_subset:
    ...
    print(f"Not saving the preprocessed lncRNA subset.")
